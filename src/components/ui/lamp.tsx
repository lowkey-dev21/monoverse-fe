  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-white to-primary py-4 bg-clip-text text-center text-5xl font-medium tracking-tight text-transparent md:text-7xl xl:text-8xl"
      >
        Blaze Your Path <br /> with Monoverse!
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[1000px] flex-col items-center justify-center overflow-hidden bg-background w-full rounded-md z-0",
        className
      )}
    >
